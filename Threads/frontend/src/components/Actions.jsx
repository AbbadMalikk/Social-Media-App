...
const Actions = ({post}) => {
  ...
  return (
    ...
    <Flex gap={3} my={2} onClick={(e)=>e.preventDefault()}>
      <svg
      color={liked?"rgb(237,73,86)": colorMode==="dark" ? "rgb(255,255,255)":"rgb(0,0,0)"}
      fill={liked?"rgb(237,73,86)": colorMode==="dark" ? "rgb(255,255,255)":"rgb(0,0,0)"}
      height={"19"}
      width={'20'}
